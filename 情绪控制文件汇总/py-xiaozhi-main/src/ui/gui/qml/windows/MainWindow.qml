            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        text: "对话内容"
                        background: Rectangle {
                            color: conversationBtn.pressed ? Theme.divider
                                : (conversationBtn.hovered
                                    ? Theme.backgroundHover : Theme.backgroundSecondary)
                            radius: Theme.radiusMd
                            border.width: 1
                            border.color: Theme.border
                        }
                        contentItem: Text {
                            text: conversationBtn.text
                            font.pixelSize: Theme.fontSizeSm
                            color: Theme.textPrimary
                            horizontalAlignment: Text.AlignHCenter
                            verticalAlignment: Text.AlignVCenter
                        }
                        onClicked: if (eventBridge) eventBridge.onOpenConversation()
                    }
